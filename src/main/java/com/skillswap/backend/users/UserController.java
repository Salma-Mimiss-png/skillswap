...
public class UserController {
	...
	@GetMapping("/{id}")
    public ResponseEntity<User> AuthentifierAppUser(@PathVariable String id) {
	...
	@PostMapping("/auth")
    public ResponseEntity<User> AuthentifierAppUser(@RequestBody AppUserDto user) {
    ...
    public ResponseEntity<User> registerAppUser(@RequestBody User user) {
    ...
    public ResponseEntity<User> modifierAppUser(@RequestBody User userModifie, @PathVariable String id) {
